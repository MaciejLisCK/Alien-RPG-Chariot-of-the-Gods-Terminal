class Room {
	...
	const AirScrubbers = new Room(
		...
		"Oczyszczacze powietrza działają z 20% wydajnością z powodu nagromadzonych zanieczyszczeń. Konieczne czyszczenie przed uruchomieniem napędu przemieszczenia. <br /><br />Dostępne tylko przez kanały wentylacyjne i szyby serwisowe. <br /> <br />Filtry węglowe oczyszczają powietrze z zanieczyszczeń, podczas gdy wirujące maszyny elektrolizują wodę i generują tlen. <br /><br />UWAGA: Elektroliza aktywna. Ryzyko porażenia prądem.",
	);
	...
	const EVAStorage = new Room(
		"Magazyn EVA",
		"Inwentarz: 3 kombinezony IRC Mk.50",
	);
	
	const LeftShower = new Room(
		"Prysznice portowe",
		"Uwaga: wykryto organizmy grzybowe.",
	);
	...
	const Cryochambers = new Room(
		...
		"Wykryto pięć sygnałów życia. 2 zmarłych. 4 komory puste.",
	);
	
	const ExaminationRoom = new Room(
		"Gabinet badań",
		"Inwentarz: 2 zestawy medyczne pierwszej pomocy.",
	);
	...
	const Vestibule1 = new Room(
		"Przedpokój 1 (Zbrojownia)",
		"Inwentarz: 1 karabin pulsacyjny M41A. 1 skrzynia nabojów do strzelby.",
	);
	const Vestibule2 = new Room(
		"Przedpokój 2 (Kombinezony EVA)",
		"Inwentarz: 2 kombinezony EVA",
	);
	const EscapePods = new Room(
		"4 kapsuły ratunkowe",
		"0/4 pozostałych kapsuł ratunkowych",
	);
	const Bridge = new Room(
		"Mostek",
		"Stacja dowodzenia - Status: operacyjny. Aktywuje napęd przemieszczenia (FTL). Zapisy lotu i załogi. <br /><br />Holograficzny stół wyświetlający - zniszczony<br /><br />Stacja sensorów: używana do nadzoru wideo statku. Obecnie wymaga napraw. <br /><br/>Monitory podtrzymania życia - analizują aktualny stan systemu podtrzymania życia.",
	);
	const JunctionB1 = new Room(
		"Węzeł B-1",
		"Dostęp A–C przez drabinę.",
	);
	...
	const MedLab = new Room(
		...
		"Próbki obcych zabezpieczone. <br /><br />Medpod1 jest uszkodzony, ale działa. Medpod2 jest w użyciu.",
	);
	const ScienceLab1 = new Room(
		"Laboratorium naukowe 1",
		"Wykryto organizmy grzybowe.",
	);
	...
	const LeftStorageUnit = new Room(
		"Magazyn portowy",
		"Inwentarz: 7 beczek quinitricetyliny (UWAGA: wysoce niestabilne)",
	);
	const RightStorageUnit = new Room(
		"Magazyn sterburtowy",
		"Inwentarz: 2 karabiny śrubowe, 1 palnik tnący, 1 podnośnik serwisowy.",
	);
	...
	const CoolantTanks = new Room(
		"Zbiorniki chłodziwa",
		"Zbiorniki chłodziwa zapobiegają przegrzaniu. <br /><br /> (Uwaga: uszkodzenie zbiorników chłodziwa może doprowadzić do osiągnięcia krytycznej masy reaktora). <br /><br />Dostępne przez tunele serwisowe.",
	);
...
Dokładnie tak, jak sugerowała rozszyfrowana transmisja — znaleźliśmy AO-3949X.91-15 na LV-1113. Zespół naukowy rozpoczął eksperymenty z czarną cieczą, nazywając ją „szczepem 26 Draconis”. Najciekawsze jest to, że substancja nie pochodzi stąd; została tu wprowadzona dawno temu. Zmutowała nawet organizmy planety. Testy genetyczne worków jajowych znalezionych w świątyni pokazują, że powstały głównie z użyciem szczepu 26 Draconis. Wgrywam naszą analizę do terminala dostępowego.\
	...
	"C.Reynolds", 
	"(3-17-2112 6:06 am)", '\
To mój obowiązek zgłosić, że Carter nie żyje. Stało się to tak szybko, że trudno mi to opisać. Najpierw skarżył się na migreny. Potem zaczęła z niego tryskać krew. Następnie Wright próbował mu udzielić pomocy, kiedy z jego ciała wyrwało się jakieś stworzenie. Porażająco pocięło Wrighta zanim zdołałem je z niego zrzucić. Pobiegło w dżunglę.\
